...
namespace vOS.UserSpace.Instance
{
    ...
    public enum ProcessWindowState
    {
        ...
        /// If a window is hidden, it is effectively disabled. A hidden window can process messages from the system or from other windows, but it cannot process input from the user or display output.
        ...
        /// To use System.Diagnostics.ProcessWindowStyle.Hidden, the System.Diagnostics.ProcessStartInfo.UseShellExecute property must be false.
        /// </summary>
        Hidden = 1,
        /// <summary>
